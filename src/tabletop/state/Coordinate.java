 ...
 * <p></p>
 * Stores horizontal and vertical positions for this tabletop.state.Coordinate.
 *
 * @author Adi
 */
public class Coordinate implements java.io.Serializable {
    ...
    public String toString() {
        return "tabletop.state.Coordinate{x=" + this.coordinateHorizontal + ", y=" + this.coordinateVertical + "}";
    }
