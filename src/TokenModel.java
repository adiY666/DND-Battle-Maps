 ...
 * <p></p>
 * Encapsulates token properties and image path for this TokenModel.
 *
 * @author Adi
 */
class TokenModel implements java.io.Serializable {
    ...
    public String toString() {
        return "TokenModel{name='" + this.displayName + "'}";
    }
